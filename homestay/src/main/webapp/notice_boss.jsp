...
<div id="MainArea">
    <div id="Main_Area2">
        <div class="mb">
            <h1>发布公告</h1>
            <form name="form1" method="post" action="/homestay/addNotice_Servlet" autocomplete="off" onsubmit=show()>

                <br />
                <label>标&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp题：
                    <input type="text" name="title" required />
                </label>
                <br />
                <label>时&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp间：
                    <input type="text" name="time" required />
                </label>
                <br />
                <label>公&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp告：
                    <textarea cols="20" rows="10" name="noticetxt"></textarea>
                </label>

                <br/>
                <br/>
                <input type="submit" class="checkbutton" value="提交公告">
            </form>
        </div>
    </div>
</div>
