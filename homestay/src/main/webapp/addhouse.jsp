...
<div id="MainArea">
    <div id="Main_Area2">
        <div class="mb">
            <h1>新增客房</h1>
            <form name="form1" method="post" action="/homestay/addHouse_Servlet" autocomplete="off" onsubmit=show()>
                ...
                <br />
                <label>客房类型：
                    <input type="text" name="housetype" required />
                </label>
                <br />
                <label>客房状态：
                    <input type="text" name="housestatue" required />
                </label>
                <br />
                <label>客房价格：
                    <input type="text" name="houseprice" required />
                </label>
                <br />
                <br/>
                <br/>
