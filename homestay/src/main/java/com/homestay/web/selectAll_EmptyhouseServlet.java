...
@WebServlet("/selectAll_EmptyhouseServlet")
public class selectAll_EmptyhouseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<house> houses = service.selectAllempty();
...
//        request.getRequestDispatcher("/houseStatue.jsp").forward(request,response);
        request.getRequestDispatcher("/houseStatue_empty.jsp").forward(request,response);
    }
}
